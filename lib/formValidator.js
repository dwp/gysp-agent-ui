...
function isThisUndefinedOrEmpty(input) {
  if (input === undefined) {
    return true;
  }
  if (input === '') {
...
module.exports = {
  ...
  claimInformationValidation(form) {
    const errors = [];
    if (isThisUndefinedOrEmpty(form.toDateDay) || isThisUndefinedOrEmpty(form.toDateMonth) || isThisUndefinedOrEmpty(form.toDateYear)) {
      errors.toDate = {
        text: i18n.t('claim-information:errors.toDate.required'),
      };
      if (isThisUndefinedOrEmpty(form.toDateDay)) {
        errors.toDateDay = true;
      }

      if (isThisUndefinedOrEmpty(form.toDateMonth)) {
        errors.toDateMonth = true;
      }

      if (isThisUndefinedOrEmpty(form.toDateYear)) {
    ...
    if (isThisUndefinedOrEmpty(form.fromDateDay)
      || isThisUndefinedOrEmpty(form.fromDateMonth)
      || isThisUndefinedOrEmpty(form.fromDateYear)) {
      errors.fromDate = {
      ...
      if (isThisUndefinedOrEmpty(form.fromDateMonth)) {
        errors.fromDateMonth = true;
      }

      if (isThisUndefinedOrEmpty(form.fromDateYear)) {
  ...
  dateOfDeathValidation(form) {
    ...
    if (isThisUndefinedOrEmpty(form.dateDay) && isThisUndefinedOrEmpty(form.dateMonth) && isThisUndefinedOrEmpty(form.dateYear)) {
      errors.date = {
    ...
    } else if (isThisUndefinedOrEmpty(form.dateDay) || isThisUndefinedOrEmpty(form.dateMonth) || isThisUndefinedOrEmpty(form.dateYear)) {
      errors.date = {
        text: i18n.t('date-of-death:fields.date.errors.incomplete'),
      };
      if (isThisUndefinedOrEmpty(form.dateDay)) {
        errors.dateDay = true;
      }

      if (isThisUndefinedOrEmpty(form.dateMonth)) {
        errors.dateMonth = true;
      }

      if (isThisUndefinedOrEmpty(form.dateYear)) {
        errors.dateYear = true;
      }
  ...
  dateOfDeathVerifedValidation(form) {
    const errors = [];
  ...
  updatePaymentStatus(form, detail) {
    const errors = [];
    if (isThisUndefinedOrEmpty(form.statusUpdate)) {
  ...
  deathDapNameValidation(form) {
    const errors = [];
    if (isThisUndefinedOrEmpty(form.name)) {
      errors.name = {
  ...
  deathDapPhoneNumberValidation(form) {
    const errors = [];
    if (isThisUndefinedOrEmpty(form.phoneNumber)) {
      errors.phoneNumber = {
  ...
  maritalPartnerNino(form, maritalStatus) {
    const errors = [];
    if (form.partnerNino !== undefined && form.partnerNino !== '') {
      if (form.partnerNino.toString().length < ninoLengthMin || form.partnerNino.toString().length > ninoLengthMax) {
        errors.partnerNino = {
          text: i18n.t(`marital-detail:${maritalStatus}.fields.nino.errors.length`),
        };
      } else if (invalidNino(form.partnerNino)) {
        errors.partnerNino = {
