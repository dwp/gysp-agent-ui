        ...
        rows: [
          {
            ...
            value: { html: `${dateHelper.longDate(regularCaptionStartDate)} to<br/> ${dateHelper.longDate(regularCaptionEndDate)}` },
          },
        ],
      },
    };
        ...
        rows: [
          {
            ...
            value: {
              html: `${dateHelper.longDate(firstCaptionStartDate)} to<br/> ${dateHelper.longDate(firstCaptionEndDate)}`,
            },
          },
        ],
      };
