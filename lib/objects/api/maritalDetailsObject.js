...
function formatPartnerPersonalDetails(details, awardDetails) {
  ...
  if (generalHelper.isNotUndefinedEmptyOrNull(details.firstName)) {
    object.firstName = details.firstName;
  }
  if (generalHelper.isNotUndefinedEmptyOrNull(details.lastName)) {
    object.surname = details.lastName;
  }
  ...
  if (generalHelper.isNotUndefinedEmptyOrNull(details.dobVerified)) {
    object.dobVerified = details.dobVerified === 'V';
  }
...
module.exports = {
  ...
  partnerDetailByItemFormatter(details, maritalShortStatus, awardDetails) {
    ...
    if (generalHelper.isNotUndefinedEmptyOrNull(details.firstName)) {
      maritalDetailObject.eventType = addOrChange(awardDetails.partnerDetail.firstName);
    }
    if (generalHelper.isNotUndefinedEmptyOrNull(details.lastName)) {
      maritalDetailObject.eventType = addOrChange(awardDetails.partnerDetail.surname);
    }
    if (generalHelper.isNotUndefinedEmptyOrNull(details.dobDay, details.dobMonth, details.dobYear)) {
