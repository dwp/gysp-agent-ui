...
function changeText(currentAward, updatedAward) {
  if (awardIncrease(currentAward, updatedAward)) {
    return i18n.t('marital-update-and-send-letter:change.increase');
  }
  return i18n.t('marital-update-and-send-letter:change.decrease');
}
...
module.exports = {
  formatter(details) {
    ...
    const paragraphs = [
      i18n.t('marital-update-and-send-letter:p-1', {
    ...
    if (firstPayment && firstPayment.arrearsExist) {
      paragraphs.push(i18n.t('marital-update-and-send-letter:p-arrears', {
    ...
    paragraphs.push(i18n.t('marital-update-and-send-letter:p-2'));
