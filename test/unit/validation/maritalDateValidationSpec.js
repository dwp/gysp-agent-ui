...
describe('Validation: marital date verification', () => {
  ...
  maritalStatuses.forEach((maritalStatus) => {
    it(`should return error when post is empty and maritalStatus is ${maritalStatus}`, () => {
      ...
      assert.equal(errors.date.text, i18next.t(`entitlement-marital-date:fields.${maritalStatus}.date.errors.required`));
    });
  ...
  describe('Field: date', () => {
    maritalStatuses.forEach((maritalStatus) => {
      it(`should return error when day is not complete and maritalStatus is ${maritalStatus}`, () => {
        ...
        assert.equal(errors.date.text, i18next.t(`entitlement-marital-date:fields.${maritalStatus}.date.errors.incomplete`));
      });
      ...
      it(`should return error when year is invalid and maritalStatus is ${maritalStatus}`, () => {
        ...
        assert.equal(Object.keys(errors).length, 2);
        assert.equal(errors.date.text, i18next.t(`entitlement-marital-date:fields.${maritalStatus}.date.errors.format`));
      });
      ...
      it(`should return error when date is in the future and maritalStatus is ${maritalStatus}`, () => {
        ...
        assert.equal(errors.date.text, i18next.t(`entitlement-marital-date:fields.${maritalStatus}.date.errors.future`));
      });
  ...
  describe('Field: verification', () => {
    maritalStatuses.forEach((maritalStatus) => {
      it(`should return error when verification is invalid and maritalStatus is ${maritalStatus}`, () => {
        ...
        assert.equal(Object.keys(errors).length, 1);
        assert.equal(errors.verification.text, i18next.t(`entitlement-marital-date:fields.${maritalStatus}.verification.errors.required`));
      });
